                                ...
                                <form action="{{ route('tutor.ejercicios.cambiar-estado', $ejercicio->id) }}"
                                    ...
                                    @if($ejercicio->estado == 'REVISION')
                                        <div class="btn-group">
                                            ...
                                            <button type="submit" name="estado" value="BORRADOR" class="btn btn-danger">
                    ...
                    <div class="card-body">
                        ...
                        @if($ejercicio->imagen)
                            <div class="mt-3 text-center">
                                <img src="{{ $ejercicio->imagen }}" alt="Diagrama del ejercicio" class="img-fluid rounded" style="max-height: 300px;">
                            </div>
                        @endif
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <table class="table table-borderless">
                            ...
                            <tr>
                                ...
                                <td>{{ $ejercicio->created_at ? $ejercicio->created_at->format('d/m/Y H:i') : 'N/A' }}</td>
                            </tr>
                            ...
                            @if($ejercicio->estado == 'PUBLICADO' && $ejercicio->updated_at)
                                <tr>
                                    ...
                                    <td>{{ $ejercicio->updated_at ? $ejercicio->updated_at->format('d/m/Y H:i') : 'N/A' }}</td>
                                </tr>
                            @endif
                        </table>
                    </div>
