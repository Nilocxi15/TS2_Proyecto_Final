...
@section('title', 'Revisar Ejercicios')
...
@section('content')
    <div class="page">
        <div class="container-fluid px-0">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="text-grey mb-2">
                        <i class="fas fa-clipboard-list me-3"></i>Revisar Ejercicios
                    </h1>
                    <p class="text-grey-50">Ejercicios pendientes de aprobación</p>
                </div>
            </div>
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <form method="GET" action="{{ route('moderador.exercises.revisions') }}" class="row g-3">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="search" class="form-control" placeholder="Buscar por enunciado..."
                            ...
                            <tbody>
                                @forelse($ejercicios as $ejercicio)
                                    <tr>
                                        ...
                                        <td>
                                            {{ $ejercicio->creador->nombre ?? 'N/A' }}
                                            {{ $ejercicio->creador->apellido ?? '' }}
                                        </td>
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="{{ route('moderador.exercises.review', $ejercicio->id) }}"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="text-center py-5">
                                            ...
                                            <p class="text-muted">No hay ejercicios pendientes de revisión</p>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
